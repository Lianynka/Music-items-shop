(async function() {
    ...
    const sliderProducts = await response.json();


    function renderProductsSlider() {
        const filteredProducts = sliderProducts.filter(product => product.type === "speaker")
        const productsContainer = document.querySelector('.slider-item');
        productsContainer.innerHTML = "";
        for (const product of filteredProducts) {
            productsContainer.innerHTML +=
                `<div class = "tab-container">
                <img src = "../img/481-model.png" alt = "jbl-gt-345" >
                <p class = "item-name" > JBL GT345 </p> <span class = "item-price"> $125. 00 </span> 
